...
const StatCard = memo(
  ({
    ...
    return (
      ...
      >
        <div
          className={`absolute inset-0 transition-colors duration-700 ${bgGlow[color]}`}
        />

        <CardHeader className="relative z-10 flex flex-row items-start justify-between p-8 pb-0">
          <div
            className={`p-3 glass border-black/5 ${colorClass[color]} transition-colors duration-300`}
          >
            {icon}
          </div>
          <div className="flex flex-col items-end">
            ...
            {variant === "hero" && (
              <div className="flex items-center gap-1.5 mt-2">
                ...
                <span className="text-[9px] font-mono text-green-600/50 font-medium">
                  LIVE_THROUGHPUT
                </span>
              </div>
            )}
        ...
        <CardContent className="relative z-10 p-8 pt-6 mt-auto">
          <div
            className={`${variant === "hero" ? "text-4xl md:text-6xl" : "text-3xl lg:text-4xl"} font-light font-sans tracking-tighter text-foreground mb-4`}
          >
            <Counter
              value={value}
              suffix={suffix}
              prefix={prefix}
              decimals={decimals}
              duration={variant === "hero" ? 2.5 : 2}
            />
          </div>
          <h3
            className={`${variant === "hero" ? "text-lg" : "text-sm"} font-medium text-primary mb-2 uppercase tracking-wider`}
          >
            {title}
          </h3>
          <p
            className={`text-muted-foreground ${variant === "hero" ? "text-sm" : "text-xs leading-relaxed"} font-light`}
          >
            {subtext}
          </p>
        </CardContent>
        ...
        <div
          className={`absolute bottom-0 left-0 h-[2px] w-full scale-x-0 group-hover:scale-x-100 transition-transform duration-500 origin-left ${color === "primary" ? "bg-primary" : color === "secondary" ? "bg-secondary" : "bg-tertiary"}`}
        />
      </MotionCard>
    );
  },
    ...
    <div className="relative w-full min-h-screen py-16 md:py-24 bg-background overflow-hidden font-futura">
      ...
      <div className="max-w-7xl relative z-20 mx-auto px-4">
        ...
        <div className="max-w-7xl mb-2 md:mb-4">
          ...
          >
            Orchestrating AI deployments across Indonesia's critical
            infrastructure, handling massive data throughput with sub-second
          ...
          >
            {!isMobile ? (
              <>
                ...
                {/* HUD Overlay */}
                <div className="absolute top-6 left-6 font-mono text-[9px] text-foreground/40 select-none z-10 flex flex-col gap-1 pointer-events-none">
                ...
                <div className="absolute bottom-6 left-6 z-10 flex flex-col gap-4 pointer-events-none">
                      ...
                      <div className="bg-background/95 backdrop-blur-2xl px-6 py-4 border border-primary/30 shadow-2xl min-w-[280px]">
                        <div className="flex justify-between items-start mb-3">
                          ...
                          <div className="p-2 border border-black/5 rounded-sm">
                            ...
                            ) : hoveredLocation.type === "International" ? (
                        ...
                        <div className="grid grid-cols-2 gap-4 border-t border-black/5 pt-3">
                          <div>
                            <p className="text-[8px] font-mono text-muted-foreground uppercase mb-0.5">
                              Location
                            </p>
                            <p className="text-xs font-medium tracking-wide text-foreground">
                              {hoveredLocation.city}, ID
                            </p>
                          </div>
                          <div>
                            <p className="text-[8px] font-mono text-muted-foreground uppercase mb-0.5">
              ...
              <div className="flex flex-col h-full p-6">
                ...
                <div className="grid grid-cols-3 gap-3 flex-1">
                  <div className="flex flex-col items-center justify-center p-4 bg-black/[0.02] border border-black/5 rounded-lg">
                    ...
                    <span className="text-2xl font-light text-foreground mb-1">
                      {mapStats.Airport}
                    </span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-12 pt-12 border-t border-black/10">
          <div className="flex items-center gap-4 border border-black/10 p-6 hover:bg-primary/[0.03] transition-all bg-black/[0.02]">
            <Globe className="w-5 h-5 text-primary" />
            <div>
              <div className="text-xl font-medium text-foreground leading-none mb-1 uppercase tracking-tight">
                34 Provinces
              </div>
