  ...
  return (
    <section className="py-24 md:py-32 bg-background relative overflow-hidden">
      ...
      <div className="max-w-[1280px] mx-auto px-4 md:px-6 lg:px-8 relative z-10">
        ...
        <InViewFade className="text-center space-y-6 mb-16 md:mb-20">
          ...
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-medium tracking-tight">
            BUILD WHAT YOU <span className="text-muted-foreground">NEED.</span>
          </h2>
        ...
        {/* Use Cases Grid - server-rendered for SEO */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
          {useCases.map((useCase, index) => (
            <InViewFade key={useCase.title} delay={0.1 + index * 0.1}>
