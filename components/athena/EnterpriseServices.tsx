...
import { InViewFade } from "@/components/lenz/DashboardShowcaseClient";
      ...
      <div className="max-w-[1280px] mx-auto px-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20">
          ...
          <div className="space-y-12">
            <InViewFade className="space-y-4">
              ...
              <p className="text-muted-foreground font-light leading-relaxed max-w-lg">
                Built on cutting-edge RAG architecture, knowledge graphs, and
                agentic workflows. Athena combines the best of retrieval and
                generation for accurate, grounded responses.
              </p>
            </InViewFade>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {llmCapabilities.map((item, i) => (
                <InViewFade key={i} delay={0.1 + i * 0.05}>
                  <div className="flex items-center gap-4 p-4 rounded-2xl bg-background border border-border/60 hover:border-primary/40 hover:shadow-lg hover:shadow-primary/5 transition-all group cursor-default">
              ...
              <div className="relative p-8 md:p-12 rounded-[2rem] border border-primary/20 bg-background/60 backdrop-blur-md space-y-8 flex flex-col justify-center h-full shadow-2xl">
                ...
                <div className="space-y-4">
                  ...
                  <p className="text-muted-foreground font-light leading-relaxed">
                    From internal knowledge bases to customer support, Athena
