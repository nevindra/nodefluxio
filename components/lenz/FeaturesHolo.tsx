...
const coreFeatures = [
    { name: "Live Streaming", icon: MonitorPlay, desc: "Zero-latency feeds" },
    { name: "Smart Alerts", icon: Bell, desc: "AI-triggered notifications" },
    { name: "Multi-User Access", icon: Users, desc: "Role-based permissions" },
    { name: "Site Mapping", icon: Map, desc: "Visual camera placement" },
    { name: "Local Storage", icon: HardDrive, desc: "On-premise recording" },
    { name: "Cloud Backup", icon: Network, desc: "Secure remote access" },
                    ...
                    <div className="space-y-12">
                        ...
                        >
                            <div className="flex items-center gap-2">
                                ...
                                <span className="text-[10px] font-mono text-primary uppercase tracking-widest">Platform Features</span>
                            </div>
                            <h3 className="text-3xl md:text-4xl font-medium tracking-tight">
                                BUILT FOR <br />
                                <span className="text-muted-foreground uppercase tracking-tight">SCALE.</span>
                            </h3>
                            <p className="text-muted-foreground font-light leading-relaxed max-w-lg">
                                Lenz is designed to handle enterprise deployments. From a handful of cameras to thousands across multiple sites.
                            </p>
                        </motion.div>
                    ...
                    >
                        ...
                        <div className="relative p-8 md:p-12 rounded-[2rem] border border-primary/20 bg-background/60 backdrop-blur-md space-y-8 flex flex-col justify-center h-full shadow-2xl">
                            ...
                            <div className="space-y-4">
                                <h3 className="text-3xl md:text-4xl font-medium tracking-tight">
                                    ENTERPRISE <br />
                                    <span className="text-primary uppercase tracking-tight">READY.</span>
                                </h3>
                                <p className="text-muted-foreground font-light leading-relaxed">
                                    Need custom deployment? On-premise installation? Integration with your existing systems? We&apos;ve got you covered.
                                </p>
                            </div>
